...
class PeminjamSertifikatModel extends Model
{
    ...
    public function getDetail($id)
    {
        return $this->db
            ...
            ->select('id_peminjam_sertifikat, nama_lengkap, nik, investasi.intro, kecamatan.kecamatan, kelurahan.kelurahan, kategori.nm_kategori, lokasi, sub_kategori.nm_subkategori, keperluan, nama_petugas_pinjam, nip_petugas_pinjam, nama_petugas_kembali,nip_petugas_kembali, tgl_pinjam, tgl_kembali, data_peminjam_sertifikat.status')
